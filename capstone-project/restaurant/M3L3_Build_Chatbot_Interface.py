...
# test_message = [
#     "Gw lagi nyari tempat nasgor di bogor",
#     "gimana cara buat pukis?",
#     "kasih tau gw saran sarapan",
...
def extract_preferences(user_message: str, llm: ChatGoogleGenerativeAI) -> Dict[str, Any]:
...
def add_restaurant(name: str, cousine: str, price: str, location: str, description: str)-> str:
...
def add_recipe(name: str, cousine: str, difficulty: str, prep_time: str, ingredients: str, instructions: str)-> str:
    """Add a new restaurant to the database."""
    # In a real implementation, this would add to the vector database
...
test_recipe_message = "Suggest some easy recipes for dinner"
